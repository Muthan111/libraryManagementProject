...
export class BorrowController {
  ...
  @Post()
  @ApiResponse({ status: 201, description: 'Borrow record created successfully.' })
  @ApiResponse({ status: 400, description: 'Book is already borrowed or request is invalid.' })
  ...
  @ApiResponse({ status: 200, description: 'User borrow history retrieved successfully.' })
  @Get('user/:id')
  ...
  @ApiResponse({ status: 200, description: 'Active borrow records retrieved successfully.' })
  @Get('active')
